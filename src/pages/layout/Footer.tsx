...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 md:mt-0 md:grid-cols-5 lg:gap-y-16">
        <div className="">
          <p className="font-medium text-white dark:text-white">Services</p>

          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-gray-200 text-xs transition hover:opacity-75 dark:text-gray-200">
                1on1 Coaching
              </a>
            </li>
        ...
        <div className="">
          <p className="font-medium text-white dark:text-white">Downloads</p>
        ...
        <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="text-gray-200 text-xs transition hover:opacity-75 dark:text-gray-200"
            >
